...
public interface VersionDiffMapper {
    ...
    /**
     * 08/19 - RD-SRS-5.2 변경분 검사용. 특정 버전을 결과로 갖는 비교의 unified diff 조회.
     * 완료된 비교만 대상으로 하며, 없으면 null.
     */
    Map<String, Object> findCompletedByToVersion(@Param("toVersionId") String toVersionId);
