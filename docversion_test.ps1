...
Check "1-1 alice login 200" ((Code @("-c", $A, "-d", "username=alice&password=alice123", "$Base/api/auth/login")) -eq "200")
Check "1-2 bob login 200" ((Code @("-c", $B, "-d", "username=bob&password=bob123", "$Base/api/auth/login")) -eq "200")
Check "1-3 admin login 200" ((Code @("-c", $AD, "-d", "username=admin&password=admin123", "$Base/api/auth/login")) -eq "200")
